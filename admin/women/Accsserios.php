...
$selectImage=$database->prepare("SELECT * from getfile Where  categoryCat='Accessories' and personName='Women'");
$selectImage->execute();
...
if(isset($_GET['remove'])){
    ...
    $deleteUser->execute();
    header("Location: Accsserios.php");
...
<div class="dropdown">
  ...
  <a class="dropdown-item" href="shirt.php">Shirts</a>
