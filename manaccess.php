...
.searchButton {
  ...
  <?php include "header.php";?>
    ...
    <div class="row mt-3">
    <div class="card col-lg-3 col-md-3 col-sm-6 " style="width: 35rem; border-style:none"> <!-- style="height: 690px;" -->
        ...
        <article class="card-group-item ">
            ...
            <div class="filter-content">
                ...
                <form method="Get">
            <?php
            $getBrand=$database->prepare("SELECT * FROM getfile where categoryCat='Accessories' and personName ='Men' GROUP BY brand ORDER BY brand  ");
            $getBrand->execute();
             $cheked =[];
            if(isset($_GET['brand'])){
              $cheked=$_GET['brand'];
