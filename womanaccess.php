...
if(isset($_GET['moveImage'])){
    ...
    // if(isset($_GET['cart'])){
      ...
      if(isset($_GET['wish'])){
        ...
        header("location: womanaccess.php");
      }
    ...
    <div class="card col-lg-3 col-md-3 col-sm-6 " style="width: 35rem; border-style:none"> 
        ...
        <article class="card-group-item ">
            ...
            <div class="filter-content">
                ...
                <form method="Get">
            <?php
            $getBrand=$database->prepare("SELECT * FROM getfile where categoryCat='Accessories' and personName ='Women' GROUP BY brand ORDER BY brand  ");
            $getBrand->execute();
             $cheked =[];
            if(isset($_GET['brand'])){
              $cheked=$_GET['brand'];
